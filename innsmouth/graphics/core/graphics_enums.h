...
#ifndef INNSMOUTH_GRAPHICS_ENUMS_H
#define INNSMOUTH_GRAPHICS_ENUMS_H
...
enum class ImageLayout {
  ...
  E_RENDERING_LOCAL_READ = VK_IMAGE_LAYOUT_RENDERING_LOCAL_READ,
  ...
  E_TENSOR_ALIASING_ARM = VK_IMAGE_LAYOUT_TENSOR_ALIASING_ARM,
  E_VIDEO_ENCODE_QUANTIZATION_MAP_KHR = VK_IMAGE_LAYOUT_VIDEO_ENCODE_QUANTIZATION_MAP_KHR,
  E_ZERO_INITIALIZED_EXT = VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT,
};
...
enum class AttachmentLoadOp {
  ...
  E_NONE = VK_ATTACHMENT_LOAD_OP_NONE,
};
...
enum class DescriptorType {
  ...
  E_TENSOR_ARM = VK_DESCRIPTOR_TYPE_TENSOR_ARM,
  E_MUTABLE_EXT = VK_DESCRIPTOR_TYPE_MUTABLE_EXT,
  E_PARTITIONED_ACCELERATION_STRUCTURE_NV = VK_DESCRIPTOR_TYPE_PARTITIONED_ACCELERATION_STRUCTURE_NV,
};
...
enum class PipelineBindPoint {
  ...
  E_DATA_GRAPH_ARM = VK_PIPELINE_BIND_POINT_DATA_GRAPH_ARM,
};
...
enum class PipelineCacheCreateMaskBits : VkPipelineCacheCreateFlags {
  ...
  E_INTERNALLY_SYNCHRONIZED_MERGE_BIT_KHR = VK_PIPELINE_CACHE_CREATE_INTERNALLY_SYNCHRONIZED_MERGE_BIT_KHR,
};
...
enum class Format {
  ...
  E_A1B5G5R5_UNORM_PACK16 = VK_FORMAT_A1B5G5R5_UNORM_PACK16,
  E_A8_UNORM = VK_FORMAT_A8_UNORM,
  ...
  E_R8_BOOL_ARM = VK_FORMAT_R8_BOOL_ARM,
  E_R16G16_SFIXED5_NV = VK_FORMAT_R16G16_SFIXED5_NV,
  E_R10X6_UINT_PACK16_ARM = VK_FORMAT_R10X6_UINT_PACK16_ARM,
  E_R10X6G10X6_UINT_2PACK16_ARM = VK_FORMAT_R10X6G10X6_UINT_2PACK16_ARM,
  E_R10X6G10X6B10X6A10X6_UINT_4PACK16_ARM = VK_FORMAT_R10X6G10X6B10X6A10X6_UINT_4PACK16_ARM,
  E_R12X4_UINT_PACK16_ARM = VK_FORMAT_R12X4_UINT_PACK16_ARM,
  E_R12X4G12X4_UINT_2PACK16_ARM = VK_FORMAT_R12X4G12X4_UINT_2PACK16_ARM,
  E_R12X4G12X4B12X4A12X4_UINT_4PACK16_ARM = VK_FORMAT_R12X4G12X4B12X4A12X4_UINT_4PACK16_ARM,
  E_R14X2_UINT_PACK16_ARM = VK_FORMAT_R14X2_UINT_PACK16_ARM,
  E_R14X2G14X2_UINT_2PACK16_ARM = VK_FORMAT_R14X2G14X2_UINT_2PACK16_ARM,
  E_R14X2G14X2B14X2A14X2_UINT_4PACK16_ARM = VK_FORMAT_R14X2G14X2B14X2A14X2_UINT_4PACK16_ARM,
  E_R14X2_UNORM_PACK16_ARM = VK_FORMAT_R14X2_UNORM_PACK16_ARM,
  E_R14X2G14X2_UNORM_2PACK16_ARM = VK_FORMAT_R14X2G14X2_UNORM_2PACK16_ARM,
  E_R14X2G14X2B14X2A14X2_UNORM_4PACK16_ARM = VK_FORMAT_R14X2G14X2B14X2A14X2_UNORM_4PACK16_ARM,
  E_G14X2_B14X2R14X2_2PLANE_420_UNORM_3PACK16_ARM = VK_FORMAT_G14X2_B14X2R14X2_2PLANE_420_UNORM_3PACK16_ARM,
  E_G14X2_B14X2R14X2_2PLANE_422_UNORM_3PACK16_ARM = VK_FORMAT_G14X2_B14X2R14X2_2PLANE_422_UNORM_3PACK16_ARM,
};
...
enum class StructureType {
  ...
  E_PHYSICAL_DEVICE_VULKAN_1_4_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_FEATURES,
  E_PHYSICAL_DEVICE_VULKAN_1_4_PROPERTIES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_PROPERTIES,
  E_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO = VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO,
  E_PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES,
  E_QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES = VK_STRUCTURE_TYPE_QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES,
  E_PHYSICAL_DEVICE_SHADER_SUBGROUP_ROTATE_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_ROTATE_FEATURES,
  E_PHYSICAL_DEVICE_SHADER_FLOAT_CONTROLS_2_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT_CONTROLS_2_FEATURES,
  E_PHYSICAL_DEVICE_SHADER_EXPECT_ASSUME_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EXPECT_ASSUME_FEATURES,
  E_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES,
  E_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO = VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO,
  E_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES,
  E_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES,
  E_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO,
  E_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES,
  E_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES,
  E_MEMORY_MAP_INFO = VK_STRUCTURE_TYPE_MEMORY_MAP_INFO,
  E_MEMORY_UNMAP_INFO = VK_STRUCTURE_TYPE_MEMORY_UNMAP_INFO,
  E_PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES,
  E_PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES,
  E_RENDERING_AREA_INFO = VK_STRUCTURE_TYPE_RENDERING_AREA_INFO,
  E_DEVICE_IMAGE_SUBRESOURCE_INFO = VK_STRUCTURE_TYPE_DEVICE_IMAGE_SUBRESOURCE_INFO,
  E_SUBRESOURCE_LAYOUT_2 = VK_STRUCTURE_TYPE_SUBRESOURCE_LAYOUT_2,
  E_IMAGE_SUBRESOURCE_2 = VK_STRUCTURE_TYPE_IMAGE_SUBRESOURCE_2,
  E_PIPELINE_CREATE_FLAGS_2_CREATE_INFO = VK_STRUCTURE_TYPE_PIPELINE_CREATE_FLAGS_2_CREATE_INFO,
  E_BUFFER_USAGE_FLAGS_2_CREATE_INFO = VK_STRUCTURE_TYPE_BUFFER_USAGE_FLAGS_2_CREATE_INFO,
  E_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES,
  E_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES,
  E_RENDERING_ATTACHMENT_LOCATION_INFO = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_LOCATION_INFO,
  E_RENDERING_INPUT_ATTACHMENT_INDEX_INFO = VK_STRUCTURE_TYPE_RENDERING_INPUT_ATTACHMENT_INDEX_INFO,
  E_PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES,
  E_PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES,
  E_BIND_MEMORY_STATUS = VK_STRUCTURE_TYPE_BIND_MEMORY_STATUS,
  E_BIND_DESCRIPTOR_SETS_INFO = VK_STRUCTURE_TYPE_BIND_DESCRIPTOR_SETS_INFO,
  E_PUSH_CONSTANTS_INFO = VK_STRUCTURE_TYPE_PUSH_CONSTANTS_INFO,
  E_PUSH_DESCRIPTOR_SET_INFO = VK_STRUCTURE_TYPE_PUSH_DESCRIPTOR_SET_INFO,
  E_PUSH_DESCRIPTOR_SET_WITH_TEMPLATE_INFO = VK_STRUCTURE_TYPE_PUSH_DESCRIPTOR_SET_WITH_TEMPLATE_INFO,
  E_PHYSICAL_DEVICE_PIPELINE_PROTECTED_ACCESS_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_PROTECTED_ACCESS_FEATURES,
  E_PIPELINE_ROBUSTNESS_CREATE_INFO = VK_STRUCTURE_TYPE_PIPELINE_ROBUSTNESS_CREATE_INFO,
  E_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_FEATURES,
  E_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_PROPERTIES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_PROPERTIES,
  E_PHYSICAL_DEVICE_HOST_IMAGE_COPY_FEATURES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_FEATURES,
  E_PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES,
  E_MEMORY_TO_IMAGE_COPY = VK_STRUCTURE_TYPE_MEMORY_TO_IMAGE_COPY,
  E_IMAGE_TO_MEMORY_COPY = VK_STRUCTURE_TYPE_IMAGE_TO_MEMORY_COPY,
  E_COPY_IMAGE_TO_MEMORY_INFO = VK_STRUCTURE_TYPE_COPY_IMAGE_TO_MEMORY_INFO,
  E_COPY_MEMORY_TO_IMAGE_INFO = VK_STRUCTURE_TYPE_COPY_MEMORY_TO_IMAGE_INFO,
  E_HOST_IMAGE_LAYOUT_TRANSITION_INFO = VK_STRUCTURE_TYPE_HOST_IMAGE_LAYOUT_TRANSITION_INFO,
  E_COPY_IMAGE_TO_IMAGE_INFO = VK_STRUCTURE_TYPE_COPY_IMAGE_TO_IMAGE_INFO,
  E_SUBRESOURCE_HOST_MEMCPY_SIZE = VK_STRUCTURE_TYPE_SUBRESOURCE_HOST_MEMCPY_SIZE,
  E_HOST_IMAGE_COPY_DEVICE_PERFORMANCE_QUERY = VK_STRUCTURE_TYPE_HOST_IMAGE_COPY_DEVICE_PERFORMANCE_QUERY,
  ...
  E_CU_MODULE_TEXTURING_MODE_CREATE_INFO_NVX = VK_STRUCTURE_TYPE_CU_MODULE_TEXTURING_MODE_CREATE_INFO_NVX,
  ...
  E_PHYSICAL_DEVICE_SHADER_BFLOAT16_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_BFLOAT16_FEATURES_KHR,
  ...
  E_PHYSICAL_DEVICE_TILE_SHADING_FEATURES_QCOM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_SHADING_FEATURES_QCOM,
  E_PHYSICAL_DEVICE_TILE_SHADING_PROPERTIES_QCOM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_SHADING_PROPERTIES_QCOM,
  E_RENDER_PASS_TILE_SHADING_CREATE_INFO_QCOM = VK_STRUCTURE_TYPE_RENDER_PASS_TILE_SHADING_CREATE_INFO_QCOM,
  E_PER_TILE_BEGIN_INFO_QCOM = VK_STRUCTURE_TYPE_PER_TILE_BEGIN_INFO_QCOM,
  E_PER_TILE_END_INFO_QCOM = VK_STRUCTURE_TYPE_PER_TILE_END_INFO_QCOM,
  E_DISPATCH_TILE_INFO_QCOM = VK_STRUCTURE_TYPE_DISPATCH_TILE_INFO_QCOM,
  ...
  E_PHYSICAL_DEVICE_SHADER_UNTYPED_POINTERS_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_UNTYPED_POINTERS_FEATURES_KHR,
  E_PHYSICAL_DEVICE_VIDEO_ENCODE_RGB_CONVERSION_FEATURES_VALVE = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_RGB_CONVERSION_FEATURES_VALVE,
  E_VIDEO_ENCODE_RGB_CONVERSION_CAPABILITIES_VALVE = VK_STRUCTURE_TYPE_VIDEO_ENCODE_RGB_CONVERSION_CAPABILITIES_VALVE,
  E_VIDEO_ENCODE_PROFILE_RGB_CONVERSION_INFO_VALVE = VK_STRUCTURE_TYPE_VIDEO_ENCODE_PROFILE_RGB_CONVERSION_INFO_VALVE,
  E_VIDEO_ENCODE_SESSION_RGB_CONVERSION_CREATE_INFO_VALVE = VK_STRUCTURE_TYPE_VIDEO_ENCODE_SESSION_RGB_CONVERSION_CREATE_INFO_VALVE,
  ...
  E_PHYSICAL_DEVICE_RAY_TRACING_LINEAR_SWEPT_SPHERES_FEATURES_NV =
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_LINEAR_SWEPT_SPHERES_FEATURES_NV,
  E_ACCELERATION_STRUCTURE_GEOMETRY_LINEAR_SWEPT_SPHERES_DATA_NV =
    VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_LINEAR_SWEPT_SPHERES_DATA_NV,
  E_ACCELERATION_STRUCTURE_GEOMETRY_SPHERES_DATA_NV = VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_SPHERES_DATA_NV,
  ...
  E_TENSOR_CREATE_INFO_ARM = VK_STRUCTURE_TYPE_TENSOR_CREATE_INFO_ARM,
  E_TENSOR_VIEW_CREATE_INFO_ARM = VK_STRUCTURE_TYPE_TENSOR_VIEW_CREATE_INFO_ARM,
  E_BIND_TENSOR_MEMORY_INFO_ARM = VK_STRUCTURE_TYPE_BIND_TENSOR_MEMORY_INFO_ARM,
  E_WRITE_DESCRIPTOR_SET_TENSOR_ARM = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_TENSOR_ARM,
  E_PHYSICAL_DEVICE_TENSOR_PROPERTIES_ARM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TENSOR_PROPERTIES_ARM,
  E_TENSOR_FORMAT_PROPERTIES_ARM = VK_STRUCTURE_TYPE_TENSOR_FORMAT_PROPERTIES_ARM,
  E_TENSOR_DESCRIPTION_ARM = VK_STRUCTURE_TYPE_TENSOR_DESCRIPTION_ARM,
  E_TENSOR_MEMORY_REQUIREMENTS_INFO_ARM = VK_STRUCTURE_TYPE_TENSOR_MEMORY_REQUIREMENTS_INFO_ARM,
  E_TENSOR_MEMORY_BARRIER_ARM = VK_STRUCTURE_TYPE_TENSOR_MEMORY_BARRIER_ARM,
  E_PHYSICAL_DEVICE_TENSOR_FEATURES_ARM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TENSOR_FEATURES_ARM,
  E_DEVICE_TENSOR_MEMORY_REQUIREMENTS_ARM = VK_STRUCTURE_TYPE_DEVICE_TENSOR_MEMORY_REQUIREMENTS_ARM,
  E_COPY_TENSOR_INFO_ARM = VK_STRUCTURE_TYPE_COPY_TENSOR_INFO_ARM,
  E_TENSOR_COPY_ARM = VK_STRUCTURE_TYPE_TENSOR_COPY_ARM,
  E_TENSOR_DEPENDENCY_INFO_ARM = VK_STRUCTURE_TYPE_TENSOR_DEPENDENCY_INFO_ARM,
  E_MEMORY_DEDICATED_ALLOCATE_INFO_TENSOR_ARM = VK_STRUCTURE_TYPE_MEMORY_DEDICATED_ALLOCATE_INFO_TENSOR_ARM,
  E_PHYSICAL_DEVICE_EXTERNAL_TENSOR_INFO_ARM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_TENSOR_INFO_ARM,
  E_EXTERNAL_TENSOR_PROPERTIES_ARM = VK_STRUCTURE_TYPE_EXTERNAL_TENSOR_PROPERTIES_ARM,
  E_EXTERNAL_MEMORY_TENSOR_CREATE_INFO_ARM = VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_TENSOR_CREATE_INFO_ARM,
  E_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_FEATURES_ARM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_FEATURES_ARM,
  E_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_PROPERTIES_ARM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_PROPERTIES_ARM,
  E_DESCRIPTOR_GET_TENSOR_INFO_ARM = VK_STRUCTURE_TYPE_DESCRIPTOR_GET_TENSOR_INFO_ARM,
  E_TENSOR_CAPTURE_DESCRIPTOR_DATA_INFO_ARM = VK_STRUCTURE_TYPE_TENSOR_CAPTURE_DESCRIPTOR_DATA_INFO_ARM,
  E_TENSOR_VIEW_CAPTURE_DESCRIPTOR_DATA_INFO_ARM = VK_STRUCTURE_TYPE_TENSOR_VIEW_CAPTURE_DESCRIPTOR_DATA_INFO_ARM,
  E_FRAME_BOUNDARY_TENSORS_ARM = VK_STRUCTURE_TYPE_FRAME_BOUNDARY_TENSORS_ARM,
  ...
  E_PHYSICAL_DEVICE_ANTI_LAG_FEATURES_AMD = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ANTI_LAG_FEATURES_AMD,
  E_ANTI_LAG_DATA_AMD = VK_STRUCTURE_TYPE_ANTI_LAG_DATA_AMD,
  E_ANTI_LAG_PRESENTATION_INFO_AMD = VK_STRUCTURE_TYPE_ANTI_LAG_PRESENTATION_INFO_AMD,
  E_SURFACE_CAPABILITIES_PRESENT_ID_2_KHR = VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_PRESENT_ID_2_KHR,
  E_PRESENT_ID_2_KHR = VK_STRUCTURE_TYPE_PRESENT_ID_2_KHR,
  E_PHYSICAL_DEVICE_PRESENT_ID_2_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_ID_2_FEATURES_KHR,
  E_SURFACE_CAPABILITIES_PRESENT_WAIT_2_KHR = VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_PRESENT_WAIT_2_KHR,
  E_PHYSICAL_DEVICE_PRESENT_WAIT_2_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_2_FEATURES_KHR,
  E_PRESENT_WAIT_2_INFO_KHR = VK_STRUCTURE_TYPE_PRESENT_WAIT_2_INFO_KHR,
  ...
  E_PHYSICAL_DEVICE_PIPELINE_BINARY_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARY_FEATURES_KHR,
  E_PIPELINE_BINARY_CREATE_INFO_KHR = VK_STRUCTURE_TYPE_PIPELINE_BINARY_CREATE_INFO_KHR,
  E_PIPELINE_BINARY_INFO_KHR = VK_STRUCTURE_TYPE_PIPELINE_BINARY_INFO_KHR,
  E_PIPELINE_BINARY_KEY_KHR = VK_STRUCTURE_TYPE_PIPELINE_BINARY_KEY_KHR,
  E_PHYSICAL_DEVICE_PIPELINE_BINARY_PROPERTIES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARY_PROPERTIES_KHR,
  E_RELEASE_CAPTURED_PIPELINE_DATA_INFO_KHR = VK_STRUCTURE_TYPE_RELEASE_CAPTURED_PIPELINE_DATA_INFO_KHR,
  E_PIPELINE_BINARY_DATA_INFO_KHR = VK_STRUCTURE_TYPE_PIPELINE_BINARY_DATA_INFO_KHR,
  E_PIPELINE_CREATE_INFO_KHR = VK_STRUCTURE_TYPE_PIPELINE_CREATE_INFO_KHR,
  E_DEVICE_PIPELINE_BINARY_INTERNAL_CACHE_CONTROL_KHR = VK_STRUCTURE_TYPE_DEVICE_PIPELINE_BINARY_INTERNAL_CACHE_CONTROL_KHR,
  E_PIPELINE_BINARY_HANDLES_INFO_KHR = VK_STRUCTURE_TYPE_PIPELINE_BINARY_HANDLES_INFO_KHR,
  ...
  E_SURFACE_PRESENT_MODE_KHR = VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_KHR,
  E_SURFACE_PRESENT_SCALING_CAPABILITIES_KHR = VK_STRUCTURE_TYPE_SURFACE_PRESENT_SCALING_CAPABILITIES_KHR,
  E_SURFACE_PRESENT_MODE_COMPATIBILITY_KHR = VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_COMPATIBILITY_KHR,
  E_PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_KHR,
  E_SWAPCHAIN_PRESENT_FENCE_INFO_KHR = VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_FENCE_INFO_KHR,
  E_SWAPCHAIN_PRESENT_MODES_CREATE_INFO_KHR = VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODES_CREATE_INFO_KHR,
  E_SWAPCHAIN_PRESENT_MODE_INFO_KHR = VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODE_INFO_KHR,
  E_SWAPCHAIN_PRESENT_SCALING_CREATE_INFO_KHR = VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_SCALING_CREATE_INFO_KHR,
  E_RELEASE_SWAPCHAIN_IMAGES_INFO_KHR = VK_STRUCTURE_TYPE_RELEASE_SWAPCHAIN_IMAGES_INFO_KHR,
  ...
  E_PHYSICAL_DEVICE_COOPERATIVE_VECTOR_FEATURES_NV = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_VECTOR_FEATURES_NV,
  E_PHYSICAL_DEVICE_COOPERATIVE_VECTOR_PROPERTIES_NV = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_VECTOR_PROPERTIES_NV,
  E_COOPERATIVE_VECTOR_PROPERTIES_NV = VK_STRUCTURE_TYPE_COOPERATIVE_VECTOR_PROPERTIES_NV,
  E_CONVERT_COOPERATIVE_VECTOR_MATRIX_INFO_NV = VK_STRUCTURE_TYPE_CONVERT_COOPERATIVE_VECTOR_MATRIX_INFO_NV,
  ...
  E_DATA_GRAPH_PIPELINE_CREATE_INFO_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CREATE_INFO_ARM,
  E_DATA_GRAPH_PIPELINE_SESSION_CREATE_INFO_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_CREATE_INFO_ARM,
  E_DATA_GRAPH_PIPELINE_RESOURCE_INFO_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_RESOURCE_INFO_ARM,
  E_DATA_GRAPH_PIPELINE_CONSTANT_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CONSTANT_ARM,
  E_DATA_GRAPH_PIPELINE_SESSION_MEMORY_REQUIREMENTS_INFO_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_MEMORY_REQUIREMENTS_INFO_ARM,
  E_BIND_DATA_GRAPH_PIPELINE_SESSION_MEMORY_INFO_ARM = VK_STRUCTURE_TYPE_BIND_DATA_GRAPH_PIPELINE_SESSION_MEMORY_INFO_ARM,
  E_PHYSICAL_DEVICE_DATA_GRAPH_FEATURES_ARM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DATA_GRAPH_FEATURES_ARM,
  E_DATA_GRAPH_PIPELINE_SHADER_MODULE_CREATE_INFO_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SHADER_MODULE_CREATE_INFO_ARM,
  E_DATA_GRAPH_PIPELINE_PROPERTY_QUERY_RESULT_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_PROPERTY_QUERY_RESULT_ARM,
  E_DATA_GRAPH_PIPELINE_INFO_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_INFO_ARM,
  E_DATA_GRAPH_PIPELINE_COMPILER_CONTROL_CREATE_INFO_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_COMPILER_CONTROL_CREATE_INFO_ARM,
  E_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENTS_INFO_ARM =
    VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENTS_INFO_ARM,
  E_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENT_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENT_ARM,
  E_DATA_GRAPH_PIPELINE_IDENTIFIER_CREATE_INFO_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_IDENTIFIER_CREATE_INFO_ARM,
  E_DATA_GRAPH_PIPELINE_DISPATCH_INFO_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_DISPATCH_INFO_ARM,
  E_DATA_GRAPH_PROCESSING_ENGINE_CREATE_INFO_ARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PROCESSING_ENGINE_CREATE_INFO_ARM,
  E_QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_PROPERTIES_ARM = VK_STRUCTURE_TYPE_QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_PROPERTIES_ARM,
  E_QUEUE_FAMILY_DATA_GRAPH_PROPERTIES_ARM = VK_STRUCTURE_TYPE_QUEUE_FAMILY_DATA_GRAPH_PROPERTIES_ARM,
  E_PHYSICAL_DEVICE_QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_INFO_ARM =
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_INFO_ARM,
  E_DATA_GRAPH_PIPELINE_CONSTANT_TENSOR_SEMI_STRUCTURED_SPARSITY_INFO_ARM =
  ...
  E_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_KHR,
  E_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_PROPERTIES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_PROPERTIES_KHR,
  ...
  E_VIDEO_ENCODE_AV1_CAPABILITIES_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_CAPABILITIES_KHR,
  E_VIDEO_ENCODE_AV1_SESSION_PARAMETERS_CREATE_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_SESSION_PARAMETERS_CREATE_INFO_KHR,
  E_VIDEO_ENCODE_AV1_PICTURE_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_PICTURE_INFO_KHR,
  E_VIDEO_ENCODE_AV1_DPB_SLOT_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_DPB_SLOT_INFO_KHR,
  E_PHYSICAL_DEVICE_VIDEO_ENCODE_AV1_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_AV1_FEATURES_KHR,
  E_VIDEO_ENCODE_AV1_PROFILE_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_PROFILE_INFO_KHR,
  E_VIDEO_ENCODE_AV1_RATE_CONTROL_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_RATE_CONTROL_INFO_KHR,
  E_VIDEO_ENCODE_AV1_RATE_CONTROL_LAYER_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_RATE_CONTROL_LAYER_INFO_KHR,
  E_VIDEO_ENCODE_AV1_QUALITY_LEVEL_PROPERTIES_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_QUALITY_LEVEL_PROPERTIES_KHR,
  E_VIDEO_ENCODE_AV1_SESSION_CREATE_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_SESSION_CREATE_INFO_KHR,
  E_VIDEO_ENCODE_AV1_GOP_REMAINING_FRAME_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_GOP_REMAINING_FRAME_INFO_KHR,
  E_PHYSICAL_DEVICE_VIDEO_DECODE_VP9_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_DECODE_VP9_FEATURES_KHR,
  E_VIDEO_DECODE_VP9_CAPABILITIES_KHR = VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_CAPABILITIES_KHR,
  E_VIDEO_DECODE_VP9_PICTURE_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_PICTURE_INFO_KHR,
  E_VIDEO_DECODE_VP9_PROFILE_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_PROFILE_INFO_KHR,
  ...
  E_PHYSICAL_DEVICE_UNIFIED_IMAGE_LAYOUTS_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFIED_IMAGE_LAYOUTS_FEATURES_KHR,
  E_ATTACHMENT_FEEDBACK_LOOP_INFO_EXT = VK_STRUCTURE_TYPE_ATTACHMENT_FEEDBACK_LOOP_INFO_EXT,
  ...
  E_PHYSICAL_DEVICE_TILE_MEMORY_HEAP_FEATURES_QCOM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_MEMORY_HEAP_FEATURES_QCOM,
  E_PHYSICAL_DEVICE_TILE_MEMORY_HEAP_PROPERTIES_QCOM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_MEMORY_HEAP_PROPERTIES_QCOM,
  E_TILE_MEMORY_REQUIREMENTS_QCOM = VK_STRUCTURE_TYPE_TILE_MEMORY_REQUIREMENTS_QCOM,
  E_TILE_MEMORY_BIND_INFO_QCOM = VK_STRUCTURE_TYPE_TILE_MEMORY_BIND_INFO_QCOM,
  E_TILE_MEMORY_SIZE_INFO_QCOM = VK_STRUCTURE_TYPE_TILE_MEMORY_SIZE_INFO_QCOM,
  E_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_FEATURES_KHR,
  E_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_PROPERTIES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_PROPERTIES_KHR,
  E_COPY_MEMORY_INDIRECT_INFO_KHR = VK_STRUCTURE_TYPE_COPY_MEMORY_INDIRECT_INFO_KHR,
  E_COPY_MEMORY_TO_IMAGE_INDIRECT_INFO_KHR = VK_STRUCTURE_TYPE_COPY_MEMORY_TO_IMAGE_INDIRECT_INFO_KHR,
  E_DISPLAY_SURFACE_STEREO_CREATE_INFO_NV = VK_STRUCTURE_TYPE_DISPLAY_SURFACE_STEREO_CREATE_INFO_NV,
  E_DISPLAY_MODE_STEREO_PROPERTIES_NV = VK_STRUCTURE_TYPE_DISPLAY_MODE_STEREO_PROPERTIES_NV,
  E_VIDEO_ENCODE_INTRA_REFRESH_CAPABILITIES_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_INTRA_REFRESH_CAPABILITIES_KHR,
  E_VIDEO_ENCODE_SESSION_INTRA_REFRESH_CREATE_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_SESSION_INTRA_REFRESH_CREATE_INFO_KHR,
  E_VIDEO_ENCODE_INTRA_REFRESH_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_INTRA_REFRESH_INFO_KHR,
  E_VIDEO_REFERENCE_INTRA_REFRESH_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_REFERENCE_INTRA_REFRESH_INFO_KHR,
  E_PHYSICAL_DEVICE_VIDEO_ENCODE_INTRA_REFRESH_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_INTRA_REFRESH_FEATURES_KHR,
  E_VIDEO_ENCODE_QUANTIZATION_MAP_CAPABILITIES_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_CAPABILITIES_KHR,
  E_VIDEO_FORMAT_QUANTIZATION_MAP_PROPERTIES_KHR = VK_STRUCTURE_TYPE_VIDEO_FORMAT_QUANTIZATION_MAP_PROPERTIES_KHR,
  E_VIDEO_ENCODE_QUANTIZATION_MAP_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_INFO_KHR,
  E_VIDEO_ENCODE_QUANTIZATION_MAP_SESSION_PARAMETERS_CREATE_INFO_KHR =
    VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_SESSION_PARAMETERS_CREATE_INFO_KHR,
  E_PHYSICAL_DEVICE_VIDEO_ENCODE_QUANTIZATION_MAP_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_QUANTIZATION_MAP_FEATURES_KHR,
  E_VIDEO_ENCODE_H264_QUANTIZATION_MAP_CAPABILITIES_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_QUANTIZATION_MAP_CAPABILITIES_KHR,
  E_VIDEO_ENCODE_H265_QUANTIZATION_MAP_CAPABILITIES_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_QUANTIZATION_MAP_CAPABILITIES_KHR,
  E_VIDEO_FORMAT_H265_QUANTIZATION_MAP_PROPERTIES_KHR = VK_STRUCTURE_TYPE_VIDEO_FORMAT_H265_QUANTIZATION_MAP_PROPERTIES_KHR,
  E_VIDEO_ENCODE_AV1_QUANTIZATION_MAP_CAPABILITIES_KHR = VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_QUANTIZATION_MAP_CAPABILITIES_KHR,
  E_VIDEO_FORMAT_AV1_QUANTIZATION_MAP_PROPERTIES_KHR = VK_STRUCTURE_TYPE_VIDEO_FORMAT_AV1_QUANTIZATION_MAP_PROPERTIES_KHR,
  E_PHYSICAL_DEVICE_RAW_ACCESS_CHAINS_FEATURES_NV = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAW_ACCESS_CHAINS_FEATURES_NV,
  E_EXTERNAL_COMPUTE_QUEUE_DEVICE_CREATE_INFO_NV = VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_DEVICE_CREATE_INFO_NV,
  E_EXTERNAL_COMPUTE_QUEUE_CREATE_INFO_NV = VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_CREATE_INFO_NV,
  E_EXTERNAL_COMPUTE_QUEUE_DATA_PARAMS_NV = VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_DATA_PARAMS_NV,
  E_PHYSICAL_DEVICE_EXTERNAL_COMPUTE_QUEUE_PROPERTIES_NV = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_COMPUTE_QUEUE_PROPERTIES_NV,
  E_PHYSICAL_DEVICE_SHADER_RELAXED_EXTENDED_INSTRUCTION_FEATURES_KHR =
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_RELAXED_EXTENDED_INSTRUCTION_FEATURES_KHR,
  E_PHYSICAL_DEVICE_COMMAND_BUFFER_INHERITANCE_FEATURES_NV = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMMAND_BUFFER_INHERITANCE_FEATURES_NV,
  ...
  E_PHYSICAL_DEVICE_SHADER_FLOAT8_FEATURES_EXT = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT8_FEATURES_EXT,
  ...
  E_PHYSICAL_DEVICE_CLUSTER_ACCELERATION_STRUCTURE_FEATURES_NV = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CLUSTER_ACCELERATION_STRUCTURE_FEATURES_NV,
  E_PHYSICAL_DEVICE_CLUSTER_ACCELERATION_STRUCTURE_PROPERTIES_NV =
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CLUSTER_ACCELERATION_STRUCTURE_PROPERTIES_NV,
  E_CLUSTER_ACCELERATION_STRUCTURE_CLUSTERS_BOTTOM_LEVEL_INPUT_NV =
    VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_CLUSTERS_BOTTOM_LEVEL_INPUT_NV,
  E_CLUSTER_ACCELERATION_STRUCTURE_TRIANGLE_CLUSTER_INPUT_NV = VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_TRIANGLE_CLUSTER_INPUT_NV,
  E_CLUSTER_ACCELERATION_STRUCTURE_MOVE_OBJECTS_INPUT_NV = VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_MOVE_OBJECTS_INPUT_NV,
  E_CLUSTER_ACCELERATION_STRUCTURE_INPUT_INFO_NV = VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_INPUT_INFO_NV,
  E_CLUSTER_ACCELERATION_STRUCTURE_COMMANDS_INFO_NV = VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_COMMANDS_INFO_NV,
  E_RAY_TRACING_PIPELINE_CLUSTER_ACCELERATION_STRUCTURE_CREATE_INFO_NV =
    VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CLUSTER_ACCELERATION_STRUCTURE_CREATE_INFO_NV,
  E_PHYSICAL_DEVICE_PARTITIONED_ACCELERATION_STRUCTURE_FEATURES_NV =
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PARTITIONED_ACCELERATION_STRUCTURE_FEATURES_NV,
  E_PHYSICAL_DEVICE_PARTITIONED_ACCELERATION_STRUCTURE_PROPERTIES_NV =
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PARTITIONED_ACCELERATION_STRUCTURE_PROPERTIES_NV,
  E_WRITE_DESCRIPTOR_SET_PARTITIONED_ACCELERATION_STRUCTURE_NV = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_PARTITIONED_ACCELERATION_STRUCTURE_NV,
  E_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCES_INPUT_NV = VK_STRUCTURE_TYPE_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCES_INPUT_NV,
  E_BUILD_PARTITIONED_ACCELERATION_STRUCTURE_INFO_NV = VK_STRUCTURE_TYPE_BUILD_PARTITIONED_ACCELERATION_STRUCTURE_INFO_NV,
  E_PARTITIONED_ACCELERATION_STRUCTURE_FLAGS_NV = VK_STRUCTURE_TYPE_PARTITIONED_ACCELERATION_STRUCTURE_FLAGS_NV,
  E_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_EXT = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_EXT,
  E_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_EXT = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_EXT,
  E_GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_EXT = VK_STRUCTURE_TYPE_GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_EXT,
  E_INDIRECT_EXECUTION_SET_CREATE_INFO_EXT = VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_CREATE_INFO_EXT,
  E_GENERATED_COMMANDS_INFO_EXT = VK_STRUCTURE_TYPE_GENERATED_COMMANDS_INFO_EXT,
  E_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_EXT = VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_EXT,
  E_INDIRECT_COMMANDS_LAYOUT_TOKEN_EXT = VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_TOKEN_EXT,
  E_WRITE_INDIRECT_EXECUTION_SET_PIPELINE_EXT = VK_STRUCTURE_TYPE_WRITE_INDIRECT_EXECUTION_SET_PIPELINE_EXT,
  E_WRITE_INDIRECT_EXECUTION_SET_SHADER_EXT = VK_STRUCTURE_TYPE_WRITE_INDIRECT_EXECUTION_SET_SHADER_EXT,
  E_INDIRECT_EXECUTION_SET_PIPELINE_INFO_EXT = VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_PIPELINE_INFO_EXT,
  E_INDIRECT_EXECUTION_SET_SHADER_INFO_EXT = VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_SHADER_INFO_EXT,
  E_INDIRECT_EXECUTION_SET_SHADER_LAYOUT_INFO_EXT = VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_SHADER_LAYOUT_INFO_EXT,
  E_GENERATED_COMMANDS_PIPELINE_INFO_EXT = VK_STRUCTURE_TYPE_GENERATED_COMMANDS_PIPELINE_INFO_EXT,
  E_GENERATED_COMMANDS_SHADER_INFO_EXT = VK_STRUCTURE_TYPE_GENERATED_COMMANDS_SHADER_INFO_EXT,
  E_PHYSICAL_DEVICE_MAINTENANCE_8_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_8_FEATURES_KHR,
  E_MEMORY_BARRIER_ACCESS_FLAGS_3_KHR = VK_STRUCTURE_TYPE_MEMORY_BARRIER_ACCESS_FLAGS_3_KHR,
  ...
  E_PHYSICAL_DEVICE_DEPTH_CLAMP_CONTROL_FEATURES_EXT = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_CONTROL_FEATURES_EXT,
  E_PIPELINE_VIEWPORT_DEPTH_CLAMP_CONTROL_CREATE_INFO_EXT = VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_DEPTH_CLAMP_CONTROL_CREATE_INFO_EXT,
  E_PHYSICAL_DEVICE_MAINTENANCE_9_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_9_FEATURES_KHR,
  E_PHYSICAL_DEVICE_MAINTENANCE_9_PROPERTIES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_9_PROPERTIES_KHR,
  E_QUEUE_FAMILY_OWNERSHIP_TRANSFER_PROPERTIES_KHR = VK_STRUCTURE_TYPE_QUEUE_FAMILY_OWNERSHIP_TRANSFER_PROPERTIES_KHR,
  E_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_2_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_2_FEATURES_KHR,
  E_VIDEO_DECODE_H264_INLINE_SESSION_PARAMETERS_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_INLINE_SESSION_PARAMETERS_INFO_KHR,
  E_VIDEO_DECODE_H265_INLINE_SESSION_PARAMETERS_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_INLINE_SESSION_PARAMETERS_INFO_KHR,
  E_VIDEO_DECODE_AV1_INLINE_SESSION_PARAMETERS_INFO_KHR = VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_INLINE_SESSION_PARAMETERS_INFO_KHR,
  E_PHYSICAL_DEVICE_HDR_VIVID_FEATURES_HUAWEI = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HDR_VIVID_FEATURES_HUAWEI,
  E_HDR_VIVID_DYNAMIC_METADATA_HUAWEI = VK_STRUCTURE_TYPE_HDR_VIVID_DYNAMIC_METADATA_HUAWEI,
  E_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_2_FEATURES_NV = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_2_FEATURES_NV,
  E_COOPERATIVE_MATRIX_FLEXIBLE_DIMENSIONS_PROPERTIES_NV = VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_FLEXIBLE_DIMENSIONS_PROPERTIES_NV,
  E_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_2_PROPERTIES_NV = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_2_PROPERTIES_NV,
  E_PHYSICAL_DEVICE_PIPELINE_OPACITY_MICROMAP_FEATURES_ARM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_OPACITY_MICROMAP_FEATURES_ARM,
  E_PHYSICAL_DEVICE_DEPTH_CLAMP_ZERO_ONE_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_ZERO_ONE_FEATURES_KHR,
  E_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT,
  E_PHYSICAL_DEVICE_FORMAT_PACK_FEATURES_ARM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FORMAT_PACK_FEATURES_ARM,
  E_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_FEATURES_VALVE = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_FEATURES_VALVE,
  E_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_PROPERTIES_VALVE =
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_PROPERTIES_VALVE,
  E_PIPELINE_FRAGMENT_DENSITY_MAP_LAYERED_CREATE_INFO_VALVE = VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_DENSITY_MAP_LAYERED_CREATE_INFO_VALVE,
  E_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_KHR,
  E_PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_KHR,
  E_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_EXT = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_EXT,
  E_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_EXT = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_EXT,
  E_RENDER_PASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_EXT = VK_STRUCTURE_TYPE_RENDER_PASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_EXT,
  E_RENDERING_END_INFO_EXT = VK_STRUCTURE_TYPE_RENDERING_END_INFO_EXT,
  E_PHYSICAL_DEVICE_ZERO_INITIALIZE_DEVICE_MEMORY_FEATURES_EXT = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_DEVICE_MEMORY_FEATURES_EXT,
  E_PHYSICAL_DEVICE_PRESENT_MODE_FIFO_LATEST_READY_FEATURES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_MODE_FIFO_LATEST_READY_FEATURES_KHR,
  E_PHYSICAL_DEVICE_PIPELINE_CACHE_INCREMENTAL_MODE_FEATURES_SEC =
...
enum class Result {
  ...
  E_ERROR_VALIDATION_FAILED = VK_ERROR_VALIDATION_FAILED,
  ...
  E_ERROR_NOT_PERMITTED = VK_ERROR_NOT_PERMITTED,
  ...
  E_PIPELINE_BINARY_MISSING_KHR = VK_PIPELINE_BINARY_MISSING_KHR,
  E_ERROR_NOT_ENOUGH_SPACE_KHR = VK_ERROR_NOT_ENOUGH_SPACE_KHR,
};
...
enum class DynamicState {
  ...
  E_LINE_STIPPLE = VK_DYNAMIC_STATE_LINE_STIPPLE,
  ...
  E_DEPTH_CLAMP_RANGE_EXT = VK_DYNAMIC_STATE_DEPTH_CLAMP_RANGE_EXT,
};

enum class DescriptorUpdateTemplateType {
  E_DESCRIPTOR_SET = VK_DESCRIPTOR_UPDATE_TEMPLATE_TYPE_DESCRIPTOR_SET,
  E_PUSH_DESCRIPTORS = VK_DESCRIPTOR_UPDATE_TEMPLATE_TYPE_PUSH_DESCRIPTORS,
};
...
enum class ObjectType {
  ...
  E_TENSOR_ARM = VK_OBJECT_TYPE_TENSOR_ARM,
  E_TENSOR_VIEW_ARM = VK_OBJECT_TYPE_TENSOR_VIEW_ARM,
  E_OPTICAL_FLOW_SESSION_NV = VK_OBJECT_TYPE_OPTICAL_FLOW_SESSION_NV,
  E_SHADER_EXT = VK_OBJECT_TYPE_SHADER_EXT,
  E_PIPELINE_BINARY_KHR = VK_OBJECT_TYPE_PIPELINE_BINARY_KHR,
  E_DATA_GRAPH_PIPELINE_SESSION_ARM = VK_OBJECT_TYPE_DATA_GRAPH_PIPELINE_SESSION_ARM,
  E_EXTERNAL_COMPUTE_QUEUE_NV = VK_OBJECT_TYPE_EXTERNAL_COMPUTE_QUEUE_NV,
  E_INDIRECT_COMMANDS_LAYOUT_EXT = VK_OBJECT_TYPE_INDIRECT_COMMANDS_LAYOUT_EXT,
  E_INDIRECT_EXECUTION_SET_EXT = VK_OBJECT_TYPE_INDIRECT_EXECUTION_SET_EXT,
};
...
enum class RayTracingLssIndexingModeNV {
  E_LIST_NV = VK_RAY_TRACING_LSS_INDEXING_MODE_LIST_NV,
  E_SUCCESSIVE_NV = VK_RAY_TRACING_LSS_INDEXING_MODE_SUCCESSIVE_NV,
};

enum class RayTracingLssPrimitiveEndCapsModeNV {
  E_NONE_NV = VK_RAY_TRACING_LSS_PRIMITIVE_END_CAPS_MODE_NONE_NV,
  E_CHAINED_NV = VK_RAY_TRACING_LSS_PRIMITIVE_END_CAPS_MODE_CHAINED_NV,
};
...
enum class AntiLagModeAMD {
  E_DRIVER_CONTROL_AMD = VK_ANTI_LAG_MODE_DRIVER_CONTROL_AMD,
  E_ON_AMD = VK_ANTI_LAG_MODE_ON_AMD,
  E_OFF_AMD = VK_ANTI_LAG_MODE_OFF_AMD,
};

enum class AntiLagStageAMD {
  E_INPUT_AMD = VK_ANTI_LAG_STAGE_INPUT_AMD,
  E_PRESENT_AMD = VK_ANTI_LAG_STAGE_PRESENT_AMD,
};
...
enum class QueueMaskBits : VkQueueFlags {
  ...
  E_DATA_GRAPH_BIT_ARM = VK_QUEUE_DATA_GRAPH_BIT_ARM,
};
...
enum class RenderPassCreateMaskBits : VkRenderPassCreateFlags {
  ...
  E_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE = VK_RENDER_PASS_CREATE_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE,
};
...
enum class MemoryHeapMaskBits : VkMemoryHeapFlags {
  ...
  E_TILE_MEMORY_BIT_QCOM = VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM,
};
...
enum class AccessMaskBits : VkAccessFlags {
  ...
  E_COMMAND_PREPROCESS_READ_BIT_EXT = VK_ACCESS_COMMAND_PREPROCESS_READ_BIT_EXT,
  E_COMMAND_PREPROCESS_WRITE_BIT_EXT = VK_ACCESS_COMMAND_PREPROCESS_WRITE_BIT_EXT,
};
...
enum class BufferUsageMaskBits : VkBufferUsageFlags {
  ...
  E_TILE_MEMORY_BIT_QCOM = VK_BUFFER_USAGE_TILE_MEMORY_BIT_QCOM,
};

enum class BufferUsageMaskBits2 : VkBufferUsageFlags2 {
  E_TRANSFER_SRC_BIT = VK_BUFFER_USAGE_2_TRANSFER_SRC_BIT,
  E_TRANSFER_DST_BIT = VK_BUFFER_USAGE_2_TRANSFER_DST_BIT,
  E_UNIFORM_TEXEL_BUFFER_BIT = VK_BUFFER_USAGE_2_UNIFORM_TEXEL_BUFFER_BIT,
  E_STORAGE_TEXEL_BUFFER_BIT = VK_BUFFER_USAGE_2_STORAGE_TEXEL_BUFFER_BIT,
  E_UNIFORM_BUFFER_BIT = VK_BUFFER_USAGE_2_UNIFORM_BUFFER_BIT,
  E_STORAGE_BUFFER_BIT = VK_BUFFER_USAGE_2_STORAGE_BUFFER_BIT,
  E_INDEX_BUFFER_BIT = VK_BUFFER_USAGE_2_INDEX_BUFFER_BIT,
  E_VERTEX_BUFFER_BIT = VK_BUFFER_USAGE_2_VERTEX_BUFFER_BIT,
  E_INDIRECT_BUFFER_BIT = VK_BUFFER_USAGE_2_INDIRECT_BUFFER_BIT,
  E_SHADER_DEVICE_ADDRESS_BIT = VK_BUFFER_USAGE_2_SHADER_DEVICE_ADDRESS_BIT,
  ...
  E_DATA_GRAPH_FOREIGN_DESCRIPTOR_BIT_ARM = VK_BUFFER_USAGE_2_DATA_GRAPH_FOREIGN_DESCRIPTOR_BIT_ARM,
  E_TILE_MEMORY_BIT_QCOM = VK_BUFFER_USAGE_2_TILE_MEMORY_BIT_QCOM,
  E_PREPROCESS_BUFFER_BIT_EXT = VK_BUFFER_USAGE_2_PREPROCESS_BUFFER_BIT_EXT,
};
...
enum class ImageUsageMaskBits : VkImageUsageFlags {
  ...
  E_HOST_TRANSFER_BIT = VK_IMAGE_USAGE_HOST_TRANSFER_BIT,
  ...
  E_TENSOR_ALIASING_BIT_ARM = VK_IMAGE_USAGE_TENSOR_ALIASING_BIT_ARM,
  E_TILE_MEMORY_BIT_QCOM = VK_IMAGE_USAGE_TILE_MEMORY_BIT_QCOM,
  E_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR = VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR,
  E_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR = VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR,
};
...
enum class ImageCreateMaskBits : VkImageCreateFlags {
  ...
  E_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT = VK_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT,
};
...
enum class PipelineCreateMaskBits : VkPipelineCreateFlags {
  ...
  E_NO_PROTECTED_ACCESS_BIT = VK_PIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT,
  E_PROTECTED_ACCESS_ONLY_BIT = VK_PIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT,
...
enum class PipelineCreateMaskBits2 : VkPipelineCreateFlags2 {
  E_DISABLE_OPTIMIZATION_BIT = VK_PIPELINE_CREATE_2_DISABLE_OPTIMIZATION_BIT,
  E_ALLOW_DERIVATIVES_BIT = VK_PIPELINE_CREATE_2_ALLOW_DERIVATIVES_BIT,
  E_DERIVATIVE_BIT = VK_PIPELINE_CREATE_2_DERIVATIVE_BIT,
  E_VIEW_INDEX_FROM_DEVICE_INDEX_BIT = VK_PIPELINE_CREATE_2_VIEW_INDEX_FROM_DEVICE_INDEX_BIT,
  E_DISPATCH_BASE_BIT = VK_PIPELINE_CREATE_2_DISPATCH_BASE_BIT,
  E_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT = VK_PIPELINE_CREATE_2_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT,
  E_EARLY_RETURN_ON_FAILURE_BIT = VK_PIPELINE_CREATE_2_EARLY_RETURN_ON_FAILURE_BIT,
  E_NO_PROTECTED_ACCESS_BIT = VK_PIPELINE_CREATE_2_NO_PROTECTED_ACCESS_BIT,
  E_PROTECTED_ACCESS_ONLY_BIT = VK_PIPELINE_CREATE_2_PROTECTED_ACCESS_ONLY_BIT,
  E_RAY_TRACING_ALLOW_SPHERES_AND_LINEAR_SWEPT_SPHERES_BIT_NV = VK_PIPELINE_CREATE_2_RAY_TRACING_ALLOW_SPHERES_AND_LINEAR_SWEPT_SPHERES_BIT_NV,
  ...
  E_DISALLOW_OPACITY_MICROMAP_BIT_ARM = VK_PIPELINE_CREATE_2_DISALLOW_OPACITY_MICROMAP_BIT_ARM,
  E_CAPTURE_DATA_BIT_KHR = VK_PIPELINE_CREATE_2_CAPTURE_DATA_BIT_KHR,
  E_INDIRECT_BINDABLE_BIT_EXT = VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_EXT,
  E_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE = VK_PIPELINE_CREATE_2_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE,
};
...
enum class PipelineStageMaskBits : VkPipelineStageFlags {
  ...
  E_COMMAND_PREPROCESS_BIT_EXT = VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_EXT,
};
...
enum class DependencyMaskBits : VkDependencyFlags {
  ...
  E_QUEUE_FAMILY_OWNERSHIP_TRANSFER_USE_ALL_STAGES_BIT_KHR = VK_DEPENDENCY_QUEUE_FAMILY_OWNERSHIP_TRANSFER_USE_ALL_STAGES_BIT_KHR,
  E_ASYMMETRIC_EVENT_BIT_KHR = VK_DEPENDENCY_ASYMMETRIC_EVENT_BIT_KHR,
};
...
enum class PresentModeKHR {
  ...
  E_FIFO_LATEST_READY_KHR = VK_PRESENT_MODE_FIFO_LATEST_READY_KHR,
};
...
enum class DisplayPlaneAlphaMaskBitsKHR : VkDisplayPlaneAlphaFlagsKHR {
...
enum class CompositeAlphaMaskBitsKHR : VkCompositeAlphaFlagsKHR {
...
enum class SurfaceTransformMaskBitsKHR : VkSurfaceTransformFlagsKHR {
...
enum class DisplaySurfaceStereoTypeNV {
  E_NONE_NV = VK_DISPLAY_SURFACE_STEREO_TYPE_NONE_NV,
  E_ONBOARD_DIN_NV = VK_DISPLAY_SURFACE_STEREO_TYPE_ONBOARD_DIN_NV,
  E_HDMI_3D_NV = VK_DISPLAY_SURFACE_STEREO_TYPE_HDMI_3D_NV,
  E_INBAND_DISPLAYPORT_NV = VK_DISPLAY_SURFACE_STEREO_TYPE_INBAND_DISPLAYPORT_NV,
};
...
enum class DebugReportMaskBitsEXT : VkDebugReportFlagsEXT {
...
enum class ExternalMemoryHandleTypeMaskBitsNV : VkExternalMemoryHandleTypeFlagsNV {
...
enum class ExternalMemoryFeatureMaskBitsNV : VkExternalMemoryFeatureFlagsNV {
...
enum class ClusterAccelerationStructureIndexFormatMaskBitsNV : VkClusterAccelerationStructureIndexFormatFlagsNV {
  E_8BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_8BIT_NV,
  E_16BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_16BIT_NV,
  E_32BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_32BIT_NV,
};

enum class ClusterAccelerationStructureTypeNV {
  E_CLUSTERS_BOTTOM_LEVEL_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_TYPE_CLUSTERS_BOTTOM_LEVEL_NV,
  E_TRIANGLE_CLUSTER_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_TYPE_TRIANGLE_CLUSTER_NV,
  E_TRIANGLE_CLUSTER_TEMPLATE_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_TYPE_TRIANGLE_CLUSTER_TEMPLATE_NV,
};

enum class ClusterAccelerationStructureOpTypeNV {
  E_MOVE_OBJECTS_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_MOVE_OBJECTS_NV,
  E_BUILD_CLUSTERS_BOTTOM_LEVEL_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_BUILD_CLUSTERS_BOTTOM_LEVEL_NV,
  E_BUILD_TRIANGLE_CLUSTER_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_BUILD_TRIANGLE_CLUSTER_NV,
  E_BUILD_TRIANGLE_CLUSTER_TEMPLATE_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_BUILD_TRIANGLE_CLUSTER_TEMPLATE_NV,
  E_INSTANTIATE_TRIANGLE_CLUSTER_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_INSTANTIATE_TRIANGLE_CLUSTER_NV,
  E_GET_CLUSTER_TEMPLATE_INDICES_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_GET_CLUSTER_TEMPLATE_INDICES_NV,
};

enum class ClusterAccelerationStructureOpModeNV {
  E_IMPLICIT_DESTINATIONS_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_OP_MODE_IMPLICIT_DESTINATIONS_NV,
  E_EXPLICIT_DESTINATIONS_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_OP_MODE_EXPLICIT_DESTINATIONS_NV,
  E_COMPUTE_SIZES_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_OP_MODE_COMPUTE_SIZES_NV,
};

enum class ClusterAccelerationStructureClusterMaskBitsNV : VkClusterAccelerationStructureClusterFlagsNV {
  E_ALLOW_DISABLE_OPACITY_MICROMAPS_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_CLUSTER_ALLOW_DISABLE_OPACITY_MICROMAPS_NV,
};

enum class ClusterAccelerationStructureGeometryMaskBitsNV : VkClusterAccelerationStructureGeometryFlagsNV {
  E_CULL_DISABLE_BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_CULL_DISABLE_BIT_NV,
  E_NO_DUPLICATE_ANYHIT_INVOCATION_BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_NO_DUPLICATE_ANYHIT_INVOCATION_BIT_NV,
  E_OPAQUE_BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_OPAQUE_BIT_NV,
};

enum class ClusterAccelerationStructureAddressResolutionMaskBitsNV : VkClusterAccelerationStructureAddressResolutionFlagsNV {
  E_NONE_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_NONE_NV,
  E_INDIRECTED_DST_IMPLICIT_DATA_BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_DST_IMPLICIT_DATA_BIT_NV,
  E_INDIRECTED_SCRATCH_DATA_BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_SCRATCH_DATA_BIT_NV,
  E_INDIRECTED_DST_ADDRESS_ARRAY_BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_DST_ADDRESS_ARRAY_BIT_NV,
  E_INDIRECTED_DST_SIZES_ARRAY_BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_DST_SIZES_ARRAY_BIT_NV,
  E_INDIRECTED_SRC_INFOS_ARRAY_BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_SRC_INFOS_ARRAY_BIT_NV,
  E_INDIRECTED_SRC_INFOS_COUNT_BIT_NV = VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_SRC_INFOS_COUNT_BIT_NV,
};
...
enum class SubgroupFeatureMaskBits : VkSubgroupFeatureFlags {
  ...
  E_ROTATE_BIT = VK_SUBGROUP_FEATURE_ROTATE_BIT,
  E_ROTATE_CLUSTERED_BIT = VK_SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT,
  E_PARTITIONED_BIT_NV = VK_SUBGROUP_FEATURE_PARTITIONED_BIT_NV,
};

enum class IndirectCommandsLayoutUsageMaskBitsNV : VkIndirectCommandsLayoutUsageFlagsNV {
...
enum class IndirectStateMaskBitsNV : VkIndirectStateFlagsNV {
...
enum class DescriptorSetLayoutCreateMaskBits : VkDescriptorSetLayoutCreateFlags {
  ...
  E_PUSH_DESCRIPTOR_BIT = VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT,
...
enum class SurfaceCounterMaskBitsEXT : VkSurfaceCounterFlagsEXT {
...
enum class MemoryAllocateMaskBits : VkMemoryAllocateFlags {
  ...
  E_ZERO_INITIALIZE_BIT_EXT = VK_MEMORY_ALLOCATE_ZERO_INITIALIZE_BIT_EXT,
};

enum class DeviceGroupPresentModeMaskBitsKHR : VkDeviceGroupPresentModeFlagsKHR {
...
enum class SwapchainCreateMaskBitsKHR : VkSwapchainCreateFlagsKHR {
  ...
  E_PRESENT_ID_2_BIT_KHR = VK_SWAPCHAIN_CREATE_PRESENT_ID_2_BIT_KHR,
  E_PRESENT_WAIT_2_BIT_KHR = VK_SWAPCHAIN_CREATE_PRESENT_WAIT_2_BIT_KHR,
  E_DEFERRED_MEMORY_ALLOCATION_BIT_KHR = VK_SWAPCHAIN_CREATE_DEFERRED_MEMORY_ALLOCATION_BIT_KHR,
};
...
enum class SubpassDescriptionMaskBits : VkSubpassDescriptionFlags {
  ...
  E_TILE_SHADING_APRON_BIT_QCOM = VK_SUBPASS_DESCRIPTION_TILE_SHADING_APRON_BIT_QCOM,
...
enum class QueueGlobalPriority {
  E_LOW = VK_QUEUE_GLOBAL_PRIORITY_LOW,
  E_MEDIUM = VK_QUEUE_GLOBAL_PRIORITY_MEDIUM,
  E_HIGH = VK_QUEUE_GLOBAL_PRIORITY_HIGH,
  E_REALTIME = VK_QUEUE_GLOBAL_PRIORITY_REALTIME,
};

enum class DebugUtilsMessageSeverityMaskBitsEXT : VkDebugUtilsMessageSeverityFlagsEXT {
...
enum class DebugUtilsMessageTypeMaskBitsEXT : VkDebugUtilsMessageTypeFlagsEXT {
...
enum class DriverId {
  ...
  E_VULKAN_SC_EMULATION_ON_VULKAN = VK_DRIVER_ID_VULKAN_SC_EMULATION_ON_VULKAN,
};

enum class ConditionalRenderingMaskBitsEXT : VkConditionalRenderingFlagsEXT {
...
enum class GeometryInstanceMaskBitsKHR : VkGeometryInstanceFlagsKHR {
  ...
  E_FORCE_OPACITY_MICROMAP_2_STATE_BIT_EXT = VK_GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_BIT_EXT,
  E_DISABLE_OPACITY_MICROMAPS_BIT_EXT = VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_EXT,
};

enum class GeometryMaskBitsKHR : VkGeometryFlagsKHR {
...
enum class BuildAccelerationStructureMaskBitsKHR : VkBuildAccelerationStructureFlagsKHR {
  ...
  E_ALLOW_OPACITY_MICROMAP_UPDATE_BIT_EXT = VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_UPDATE_BIT_EXT,
  E_ALLOW_DISABLE_OPACITY_MICROMAPS_BIT_EXT = VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DISABLE_OPACITY_MICROMAPS_BIT_EXT,
  E_ALLOW_OPACITY_MICROMAP_DATA_UPDATE_BIT_EXT = VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_DATA_UPDATE_BIT_EXT,
  E_ALLOW_DATA_ACCESS_BIT_KHR = VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DATA_ACCESS_BIT_KHR,
  E_ALLOW_CLUSTER_OPACITY_MICROMAPS_BIT_NV = VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_CLUSTER_OPACITY_MICROMAPS_BIT_NV,
};

enum class AccelerationStructureCreateMaskBitsKHR : VkAccelerationStructureCreateFlagsKHR {
...
enum class GeometryTypeKHR {
  ...
  E_SPHERES_NV = VK_GEOMETRY_TYPE_SPHERES_NV,
  E_LINEAR_SWEPT_SPHERES_NV = VK_GEOMETRY_TYPE_LINEAR_SWEPT_SPHERES_NV,
};
...
enum class QueryPoolCreateMaskBits : VkQueryPoolCreateFlags {
  E_RESET_BIT_KHR = VK_QUERY_POOL_CREATE_RESET_BIT_KHR,
};

enum class DeviceDiagnosticsConfigMaskBitsNV : VkDeviceDiagnosticsConfigFlagsNV {
...
enum class MemoryDecompressionMethodMaskBitsNV : VkMemoryDecompressionMethodFlagsNV {
...
enum class PerformanceCounterDescriptionMaskBitsKHR : VkPerformanceCounterDescriptionFlagsKHR {
...
enum class AcquireProfilingLockMaskBitsKHR : VkAcquireProfilingLockFlagsKHR {
};

enum class ShaderCorePropertiesMaskBitsAMD : VkShaderCorePropertiesFlagsAMD {
};
...
enum class LineRasterizationMode {
  E_DEFAULT = VK_LINE_RASTERIZATION_MODE_DEFAULT,
  E_RECTANGULAR = VK_LINE_RASTERIZATION_MODE_RECTANGULAR,
  E_BRESENHAM = VK_LINE_RASTERIZATION_MODE_BRESENHAM,
  E_RECTANGULAR_SMOOTH = VK_LINE_RASTERIZATION_MODE_RECTANGULAR_SMOOTH,
};

enum class ShaderModuleCreateMaskBits : VkShaderModuleCreateFlags {
};

enum class PipelineCompilerControlMaskBitsAMD : VkPipelineCompilerControlFlagsAMD {
};
...
enum class AccessMaskBits2 : VkAccessFlags2 {
  ...
  E_SHADER_TILE_ATTACHMENT_READ_BIT_QCOM = VK_ACCESS_2_SHADER_TILE_ATTACHMENT_READ_BIT_QCOM,
  E_SHADER_TILE_ATTACHMENT_WRITE_BIT_QCOM = VK_ACCESS_2_SHADER_TILE_ATTACHMENT_WRITE_BIT_QCOM,
  ...
  E_COMMAND_PREPROCESS_READ_BIT_EXT = VK_ACCESS_2_COMMAND_PREPROCESS_READ_BIT_EXT,
  E_COMMAND_PREPROCESS_WRITE_BIT_EXT = VK_ACCESS_2_COMMAND_PREPROCESS_WRITE_BIT_EXT,
  ...
  E_DATA_GRAPH_READ_BIT_ARM = VK_ACCESS_2_DATA_GRAPH_READ_BIT_ARM,
  E_DATA_GRAPH_WRITE_BIT_ARM = VK_ACCESS_2_DATA_GRAPH_WRITE_BIT_ARM,
};
...
enum class PipelineStageMaskBits2 : VkPipelineStageFlags2 {
  ...
  E_COMMAND_PREPROCESS_BIT_EXT = VK_PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_EXT,
  ...
  E_CONVERT_COOPERATIVE_VECTOR_MATRIX_BIT_NV = VK_PIPELINE_STAGE_2_CONVERT_COOPERATIVE_VECTOR_MATRIX_BIT_NV,
  E_DATA_GRAPH_BIT_ARM = VK_PIPELINE_STAGE_2_DATA_GRAPH_BIT_ARM,
  E_COPY_INDIRECT_BIT_KHR = VK_PIPELINE_STAGE_2_COPY_INDIRECT_BIT_KHR,
};
...
enum class GraphicsPipelineLibraryMaskBitsEXT : VkGraphicsPipelineLibraryFlagsEXT {
...
enum class DeviceAddressBindingMaskBitsEXT : VkDeviceAddressBindingFlagsEXT {
...
enum class FrameBoundaryMaskBitsEXT : VkFrameBoundaryFlagsEXT {
  E_FRAME_END_BIT_EXT = VK_FRAME_BOUNDARY_FRAME_END_BIT_EXT,
};

enum class PresentScalingMaskBitsKHR : VkPresentScalingFlagsKHR {
  E_ONE_TO_ONE_BIT_KHR = VK_PRESENT_SCALING_ONE_TO_ONE_BIT_KHR,
  E_ASPECT_RATIO_STRETCH_BIT_KHR = VK_PRESENT_SCALING_ASPECT_RATIO_STRETCH_BIT_KHR,
  E_STRETCH_BIT_KHR = VK_PRESENT_SCALING_STRETCH_BIT_KHR,
};

enum class PresentGravityMaskBitsKHR : VkPresentGravityFlagsKHR {
  E_MIN_BIT_KHR = VK_PRESENT_GRAVITY_MIN_BIT_KHR,
  E_MAX_BIT_KHR = VK_PRESENT_GRAVITY_MAX_BIT_KHR,
  E_CENTERED_BIT_KHR = VK_PRESENT_GRAVITY_CENTERED_BIT_KHR,
};

enum class PhysicalDeviceSchedulingControlsMaskBitsARM : VkPhysicalDeviceSchedulingControlsFlagsARM {
  E_SHADER_CORE_COUNT_ARM = VK_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_SHADER_CORE_COUNT_ARM,
};

enum class VideoCodecOperationMaskBitsKHR : VkVideoCodecOperationFlagsKHR {
  ...
  E_ENCODE_AV1_BIT_KHR = VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR,
  E_DECODE_VP9_BIT_KHR = VK_VIDEO_CODEC_OPERATION_DECODE_VP9_BIT_KHR,
};

enum class VideoChromaSubsamplingMaskBitsKHR : VkVideoChromaSubsamplingFlagsKHR {
...
enum class VideoComponentBitDepthMaskBitsKHR : VkVideoComponentBitDepthFlagsKHR {
...
enum class VideoCapabilityMaskBitsKHR : VkVideoCapabilityFlagsKHR {
...
enum class VideoSessionCreateMaskBitsKHR : VkVideoSessionCreateFlagsKHR {
  ...
  E_ALLOW_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR = VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR,
  E_ALLOW_ENCODE_EMPHASIS_MAP_BIT_KHR = VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_EMPHASIS_MAP_BIT_KHR,
  E_INLINE_SESSION_PARAMETERS_BIT_KHR = VK_VIDEO_SESSION_CREATE_INLINE_SESSION_PARAMETERS_BIT_KHR,
};

enum class VideoSessionParametersCreateMaskBitsKHR : VkVideoSessionParametersCreateFlagsKHR {
  E_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR = VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR,
};

enum class VideoDecodeH264PictureLayoutMaskBitsKHR : VkVideoDecodeH264PictureLayoutFlagsKHR {
...
enum class VideoCodingControlMaskBitsKHR : VkVideoCodingControlFlagsKHR {
...
enum class VideoDecodeUsageMaskBitsKHR : VkVideoDecodeUsageFlagsKHR {
...
enum class VideoDecodeCapabilityMaskBitsKHR : VkVideoDecodeCapabilityFlagsKHR {
...
enum class VideoEncodeMaskBitsKHR : VkVideoEncodeFlagsKHR {
  E_INTRA_REFRESH_BIT_KHR = VK_VIDEO_ENCODE_INTRA_REFRESH_BIT_KHR,
  E_WITH_QUANTIZATION_DELTA_MAP_BIT_KHR = VK_VIDEO_ENCODE_WITH_QUANTIZATION_DELTA_MAP_BIT_KHR,
  E_WITH_EMPHASIS_MAP_BIT_KHR = VK_VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR,
};

enum class VideoEncodeUsageMaskBitsKHR : VkVideoEncodeUsageFlagsKHR {
...
enum class VideoEncodeContentMaskBitsKHR : VkVideoEncodeContentFlagsKHR {
...
enum class VideoEncodeCapabilityMaskBitsKHR : VkVideoEncodeCapabilityFlagsKHR {
  ...
  E_QUANTIZATION_DELTA_MAP_BIT_KHR = VK_VIDEO_ENCODE_CAPABILITY_QUANTIZATION_DELTA_MAP_BIT_KHR,
  E_EMPHASIS_MAP_BIT_KHR = VK_VIDEO_ENCODE_CAPABILITY_EMPHASIS_MAP_BIT_KHR,
};

enum class VideoEncodeFeedbackMaskBitsKHR : VkVideoEncodeFeedbackFlagsKHR {
...
enum class VideoEncodeRateControlModeMaskBitsKHR : VkVideoEncodeRateControlModeFlagsKHR {
...
enum class VideoEncodeIntraRefreshModeMaskBitsKHR : VkVideoEncodeIntraRefreshModeFlagsKHR {
  E_NONE_KHR = VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_NONE_KHR,
  E_PER_PICTURE_PARTITION_BIT_KHR = VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_PER_PICTURE_PARTITION_BIT_KHR,
  E_BLOCK_BASED_BIT_KHR = VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_BLOCK_BASED_BIT_KHR,
  E_BLOCK_ROW_BASED_BIT_KHR = VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_BLOCK_ROW_BASED_BIT_KHR,
  E_BLOCK_COLUMN_BASED_BIT_KHR = VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_BLOCK_COLUMN_BASED_BIT_KHR,
};

enum class VideoEncodeH264CapabilityMaskBitsKHR : VkVideoEncodeH264CapabilityFlagsKHR {
  ...
  E_B_PICTURE_INTRA_REFRESH_BIT_KHR = VK_VIDEO_ENCODE_H264_CAPABILITY_B_PICTURE_INTRA_REFRESH_BIT_KHR,
  E_MB_QP_DIFF_WRAPAROUND_BIT_KHR = VK_VIDEO_ENCODE_H264_CAPABILITY_MB_QP_DIFF_WRAPAROUND_BIT_KHR,
};

enum class VideoEncodeH264StdMaskBitsKHR : VkVideoEncodeH264StdFlagsKHR {
...
enum class VideoEncodeH264RateControlMaskBitsKHR : VkVideoEncodeH264RateControlFlagsKHR {
...
enum class HostImageCopyMaskBits : VkHostImageCopyFlags {
  E_MEMCPY_BIT = VK_HOST_IMAGE_COPY_MEMCPY_BIT,
};

enum class PartitionedAccelerationStructureOpTypeNV {
  E_WRITE_INSTANCE_NV = VK_PARTITIONED_ACCELERATION_STRUCTURE_OP_TYPE_WRITE_INSTANCE_NV,
  E_UPDATE_INSTANCE_NV = VK_PARTITIONED_ACCELERATION_STRUCTURE_OP_TYPE_UPDATE_INSTANCE_NV,
  E_WRITE_PARTITION_TRANSLATION_NV = VK_PARTITIONED_ACCELERATION_STRUCTURE_OP_TYPE_WRITE_PARTITION_TRANSLATION_NV,
};

enum class PartitionedAccelerationStructureInstanceMaskBitsNV : VkPartitionedAccelerationStructureInstanceFlagsNV {
  E_FLAG_TRIANGLE_FACING_CULL_DISABLE_BIT_NV = VK_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCE_FLAG_TRIANGLE_FACING_CULL_DISABLE_BIT_NV,
  E_FLAG_TRIANGLE_FLIP_FACING_BIT_NV = VK_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCE_FLAG_TRIANGLE_FLIP_FACING_BIT_NV,
  E_FLAG_FORCE_OPAQUE_BIT_NV = VK_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCE_FLAG_FORCE_OPAQUE_BIT_NV,
  E_FLAG_FORCE_NO_OPAQUE_BIT_NV = VK_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCE_FLAG_FORCE_NO_OPAQUE_BIT_NV,
  E_FLAG_ENABLE_EXPLICIT_BOUNDING_BOX_NV = VK_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCE_FLAG_ENABLE_EXPLICIT_BOUNDING_BOX_NV,
};
...
enum class FormatFeatureMaskBits2 : VkFormatFeatureFlags2 {
  ...
  E_HOST_IMAGE_TRANSFER_BIT = VK_FORMAT_FEATURE_2_HOST_IMAGE_TRANSFER_BIT,
  ...
  E_ACCELERATION_STRUCTURE_RADIUS_BUFFER_BIT_NV = VK_FORMAT_FEATURE_2_ACCELERATION_STRUCTURE_RADIUS_BUFFER_BIT_NV,
  ...
  E_TENSOR_SHADER_BIT_ARM = VK_FORMAT_FEATURE_2_TENSOR_SHADER_BIT_ARM,
  E_TENSOR_IMAGE_ALIASING_BIT_ARM = VK_FORMAT_FEATURE_2_TENSOR_IMAGE_ALIASING_BIT_ARM,
  ...
  E_TENSOR_DATA_GRAPH_BIT_ARM = VK_FORMAT_FEATURE_2_TENSOR_DATA_GRAPH_BIT_ARM,
  E_COPY_IMAGE_INDIRECT_DST_BIT_KHR = VK_FORMAT_FEATURE_2_COPY_IMAGE_INDIRECT_DST_BIT_KHR,
  E_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR = VK_FORMAT_FEATURE_2_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR,
  E_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR = VK_FORMAT_FEATURE_2_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR,
};
...
enum class RenderingMaskBits : VkRenderingFlags {
  ...
  E_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE = VK_RENDERING_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE,
};

enum class VideoEncodeH265CapabilityMaskBitsKHR : VkVideoEncodeH265CapabilityFlagsKHR {
  ...
  E_B_PICTURE_INTRA_REFRESH_BIT_KHR = VK_VIDEO_ENCODE_H265_CAPABILITY_B_PICTURE_INTRA_REFRESH_BIT_KHR,
  E_CU_QP_DIFF_WRAPAROUND_BIT_KHR = VK_VIDEO_ENCODE_H265_CAPABILITY_CU_QP_DIFF_WRAPAROUND_BIT_KHR,
};

enum class VideoEncodeH265StdMaskBitsKHR : VkVideoEncodeH265StdFlagsKHR {
...
enum class VideoEncodeH265RateControlMaskBitsKHR : VkVideoEncodeH265RateControlFlagsKHR {
...
enum class VideoEncodeH265CtbSizeMaskBitsKHR : VkVideoEncodeH265CtbSizeFlagsKHR {
...
enum class VideoEncodeH265TransformBlockSizeMaskBitsKHR : VkVideoEncodeH265TransformBlockSizeFlagsKHR {
...
enum class VideoEncodeAV1CapabilityMaskBitsKHR : VkVideoEncodeAV1CapabilityFlagsKHR {
  E_PER_RATE_CONTROL_GROUP_MIN_MAX_Q_INDEX_BIT_KHR = VK_VIDEO_ENCODE_AV1_CAPABILITY_PER_RATE_CONTROL_GROUP_MIN_MAX_Q_INDEX_BIT_KHR,
  E_GENERATE_OBU_EXTENSION_HEADER_BIT_KHR = VK_VIDEO_ENCODE_AV1_CAPABILITY_GENERATE_OBU_EXTENSION_HEADER_BIT_KHR,
  E_PRIMARY_REFERENCE_CDF_ONLY_BIT_KHR = VK_VIDEO_ENCODE_AV1_CAPABILITY_PRIMARY_REFERENCE_CDF_ONLY_BIT_KHR,
  E_FRAME_SIZE_OVERRIDE_BIT_KHR = VK_VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE_BIT_KHR,
  E_MOTION_VECTOR_SCALING_BIT_KHR = VK_VIDEO_ENCODE_AV1_CAPABILITY_MOTION_VECTOR_SCALING_BIT_KHR,
  E_COMPOUND_PREDICTION_INTRA_REFRESH_BIT_KHR = VK_VIDEO_ENCODE_AV1_CAPABILITY_COMPOUND_PREDICTION_INTRA_REFRESH_BIT_KHR,
};

enum class VideoEncodeAV1StdMaskBitsKHR : VkVideoEncodeAV1StdFlagsKHR {
  E_UNIFORM_TILE_SPACING_FLAG_SET_BIT_KHR = VK_VIDEO_ENCODE_AV1_STD_UNIFORM_TILE_SPACING_FLAG_SET_BIT_KHR,
  E_SKIP_MODE_PRESENT_UNSET_BIT_KHR = VK_VIDEO_ENCODE_AV1_STD_SKIP_MODE_PRESENT_UNSET_BIT_KHR,
  E_PRIMARY_REF_FRAME_BIT_KHR = VK_VIDEO_ENCODE_AV1_STD_PRIMARY_REF_FRAME_BIT_KHR,
  E_DELTA_Q_BIT_KHR = VK_VIDEO_ENCODE_AV1_STD_DELTA_Q_BIT_KHR,
};

enum class VideoEncodeAV1RateControlMaskBitsKHR : VkVideoEncodeAV1RateControlFlagsKHR {
  E_REGULAR_GOP_BIT_KHR = VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REGULAR_GOP_BIT_KHR,
  E_TEMPORAL_LAYER_PATTERN_DYADIC_BIT_KHR = VK_VIDEO_ENCODE_AV1_RATE_CONTROL_TEMPORAL_LAYER_PATTERN_DYADIC_BIT_KHR,
  E_REFERENCE_PATTERN_FLAT_BIT_KHR = VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_FLAT_BIT_KHR,
  E_REFERENCE_PATTERN_DYADIC_BIT_KHR = VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_DYADIC_BIT_KHR,
};

enum class VideoEncodeAV1SuperblockSizeMaskBitsKHR : VkVideoEncodeAV1SuperblockSizeFlagsKHR {
  E_64_BIT_KHR = VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_64_BIT_KHR,
  E_128_BIT_KHR = VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_128_BIT_KHR,
};

enum class VideoEncodeAV1PredictionModeKHR {
  E_INTRA_ONLY_KHR = VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_INTRA_ONLY_KHR,
  E_SINGLE_REFERENCE_KHR = VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_SINGLE_REFERENCE_KHR,
  E_UNIDIRECTIONAL_COMPOUND_KHR = VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_UNIDIRECTIONAL_COMPOUND_KHR,
  E_BIDIRECTIONAL_COMPOUND_KHR = VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_BIDIRECTIONAL_COMPOUND_KHR,
};

enum class VideoEncodeAV1RateControlGroupKHR {
  E_INTRA_KHR = VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_INTRA_KHR,
  E_PREDICTIVE_KHR = VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_PREDICTIVE_KHR,
  E_BIPREDICTIVE_KHR = VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_BIPREDICTIVE_KHR,
};
...
enum class ImageCompressionMaskBitsEXT : VkImageCompressionFlagsEXT {
...
enum class ImageCompressionFixedRateMaskBitsEXT : VkImageCompressionFixedRateFlagsEXT {
...
enum class PipelineRobustnessBufferBehavior {
  E_DEVICE_DEFAULT = VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_DEVICE_DEFAULT,
  E_DISABLED = VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_DISABLED,
  E_ROBUST_BUFFER_ACCESS = VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS,
  E_ROBUST_BUFFER_ACCESS_2 = VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS_2,
};

enum class PipelineRobustnessImageBehavior {
  E_DEVICE_DEFAULT = VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_DEVICE_DEFAULT,
  E_DISABLED = VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_DISABLED,
  E_ROBUST_IMAGE_ACCESS = VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS,
  E_ROBUST_IMAGE_ACCESS_2 = VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS_2,
};

enum class OpticalFlowGridSizeMaskBitsNV : VkOpticalFlowGridSizeFlagsNV {
...
enum class OpticalFlowUsageMaskBitsNV : VkOpticalFlowUsageFlagsNV {
...
enum class OpticalFlowSessionCreateMaskBitsNV : VkOpticalFlowSessionCreateFlagsNV {
...
enum class OpticalFlowExecuteMaskBitsNV : VkOpticalFlowExecuteFlagsNV {
...
enum class BuildMicromapMaskBitsEXT : VkBuildMicromapFlagsEXT {
...
enum class MicromapCreateMaskBitsEXT : VkMicromapCreateFlagsEXT {
...
enum class OpacityMicromapSpecialIndexEXT {
  ...
  E_CLUSTER_GEOMETRY_DISABLE_OPACITY_MICROMAP_NV = VK_OPACITY_MICROMAP_SPECIAL_INDEX_CLUSTER_GEOMETRY_DISABLE_OPACITY_MICROMAP_NV,
};
...
enum class IndirectCommandsLayoutUsageMaskBitsEXT : VkIndirectCommandsLayoutUsageFlagsEXT {
  E_EXPLICIT_PREPROCESS_BIT_EXT = VK_INDIRECT_COMMANDS_LAYOUT_USAGE_EXPLICIT_PREPROCESS_BIT_EXT,
  E_UNORDERED_SEQUENCES_BIT_EXT = VK_INDIRECT_COMMANDS_LAYOUT_USAGE_UNORDERED_SEQUENCES_BIT_EXT,
};

enum class IndirectExecutionSetInfoTypeEXT {
  E_PIPELINES_EXT = VK_INDIRECT_EXECUTION_SET_INFO_TYPE_PIPELINES_EXT,
  E_SHADER_OBJECTS_EXT = VK_INDIRECT_EXECUTION_SET_INFO_TYPE_SHADER_OBJECTS_EXT,
};

enum class IndirectCommandsInputModeMaskBitsEXT : VkIndirectCommandsInputModeFlagsEXT {
  E_VULKAN_INDEX_BUFFER_EXT = VK_INDIRECT_COMMANDS_INPUT_MODE_VULKAN_INDEX_BUFFER_EXT,
  E_DXGI_INDEX_BUFFER_EXT = VK_INDIRECT_COMMANDS_INPUT_MODE_DXGI_INDEX_BUFFER_EXT,
};

enum class IndirectCommandsTokenTypeEXT {
  E_EXECUTION_SET_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_EXECUTION_SET_EXT,
  E_PUSH_CONSTANT_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_PUSH_CONSTANT_EXT,
  E_SEQUENCE_INDEX_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_SEQUENCE_INDEX_EXT,
  E_INDEX_BUFFER_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_INDEX_BUFFER_EXT,
  E_VERTEX_BUFFER_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_VERTEX_BUFFER_EXT,
  E_DRAW_INDEXED_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_INDEXED_EXT,
  E_DRAW_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_EXT,
  E_DRAW_INDEXED_COUNT_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_INDEXED_COUNT_EXT,
  E_DRAW_COUNT_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_COUNT_EXT,
  E_DISPATCH_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_DISPATCH_EXT,
  E_DRAW_MESH_TASKS_NV_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_NV_EXT,
  E_DRAW_MESH_TASKS_COUNT_NV_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_COUNT_NV_EXT,
  E_DRAW_MESH_TASKS_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_EXT,
  E_DRAW_MESH_TASKS_COUNT_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_MESH_TASKS_COUNT_EXT,
  E_TRACE_RAYS2_EXT = VK_INDIRECT_COMMANDS_TOKEN_TYPE_TRACE_RAYS2_EXT,
};

enum class ShaderCreateMaskBitsEXT : VkShaderCreateFlagsEXT {
  ...
  E_INDIRECT_BINDABLE_BIT_EXT = VK_SHADER_CREATE_INDIRECT_BINDABLE_BIT_EXT,
};
...
enum class ComponentTypeKHR {
  ...
  E_BFLOAT16_KHR = VK_COMPONENT_TYPE_BFLOAT16_KHR,
  E_SINT8_PACKED_NV = VK_COMPONENT_TYPE_SINT8_PACKED_NV,
  E_UINT8_PACKED_NV = VK_COMPONENT_TYPE_UINT8_PACKED_NV,
  E_FLOAT8_E4M3_EXT = VK_COMPONENT_TYPE_FLOAT8_E4M3_EXT,
  E_FLOAT8_E5M2_EXT = VK_COMPONENT_TYPE_FLOAT8_E5M2_EXT,
};
...
enum class MemoryUnmapMaskBits : VkMemoryUnmapFlags {
  E_RESERVE_BIT_EXT = VK_MEMORY_UNMAP_RESERVE_BIT_EXT,
};

enum class DepthClampModeEXT {
  E_VIEWPORT_RANGE_EXT = VK_DEPTH_CLAMP_MODE_VIEWPORT_RANGE_EXT,
  E_USER_DEFINED_RANGE_EXT = VK_DEPTH_CLAMP_MODE_USER_DEFINED_RANGE_EXT,
};

enum class AccessMaskBits3KHR : VkAccessFlags3KHR {
  E_NONE_KHR = VK_ACCESS_3_NONE_KHR,
};

enum class TileShadingRenderPassMaskBitsQCOM : VkTileShadingRenderPassFlagsQCOM {
  E_ENABLE_BIT_QCOM = VK_TILE_SHADING_RENDER_PASS_ENABLE_BIT_QCOM,
  E_PER_TILE_EXECUTION_BIT_QCOM = VK_TILE_SHADING_RENDER_PASS_PER_TILE_EXECUTION_BIT_QCOM,
};

enum class CooperativeVectorMatrixLayoutNV {
  E_ROW_MAJOR_NV = VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_ROW_MAJOR_NV,
  E_COLUMN_MAJOR_NV = VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_COLUMN_MAJOR_NV,
  E_INFERENCING_OPTIMAL_NV = VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_INFERENCING_OPTIMAL_NV,
  E_TRAINING_OPTIMAL_NV = VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_TRAINING_OPTIMAL_NV,
};

enum class AddressCopyMaskBitsKHR : VkAddressCopyFlagsKHR {
  E_DEVICE_LOCAL_BIT_KHR = VK_ADDRESS_COPY_DEVICE_LOCAL_BIT_KHR,
  E_SPARSE_BIT_KHR = VK_ADDRESS_COPY_SPARSE_BIT_KHR,
  E_PROTECTED_BIT_KHR = VK_ADDRESS_COPY_PROTECTED_BIT_KHR,
};

enum class TensorCreateMaskBitsARM : VkTensorCreateFlagsARM {
  E_MUTABLE_FORMAT_BIT_ARM = VK_TENSOR_CREATE_MUTABLE_FORMAT_BIT_ARM,
  E_PROTECTED_BIT_ARM = VK_TENSOR_CREATE_PROTECTED_BIT_ARM,
  E_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM = VK_TENSOR_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM,
};

enum class TensorUsageMaskBitsARM : VkTensorUsageFlagsARM {
  E_SHADER_BIT_ARM = VK_TENSOR_USAGE_SHADER_BIT_ARM,
  E_TRANSFER_SRC_BIT_ARM = VK_TENSOR_USAGE_TRANSFER_SRC_BIT_ARM,
  E_TRANSFER_DST_BIT_ARM = VK_TENSOR_USAGE_TRANSFER_DST_BIT_ARM,
  E_IMAGE_ALIASING_BIT_ARM = VK_TENSOR_USAGE_IMAGE_ALIASING_BIT_ARM,
  E_DATA_GRAPH_BIT_ARM = VK_TENSOR_USAGE_DATA_GRAPH_BIT_ARM,
};

enum class TensorTilingARM {
  E_OPTIMAL_ARM = VK_TENSOR_TILING_OPTIMAL_ARM,
  E_LINEAR_ARM = VK_TENSOR_TILING_LINEAR_ARM,
};

enum class TensorViewCreateMaskBitsARM : VkTensorViewCreateFlagsARM {
  E_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM = VK_TENSOR_VIEW_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM,
};

enum class DefaultVertexAttributeValueKHR {
  E_ZERO_ZERO_ZERO_ZERO_KHR = VK_DEFAULT_VERTEX_ATTRIBUTE_VALUE_ZERO_ZERO_ZERO_ZERO_KHR,
  E_ZERO_ZERO_ZERO_ONE_KHR = VK_DEFAULT_VERTEX_ATTRIBUTE_VALUE_ZERO_ZERO_ZERO_ONE_KHR,
};

enum class DataGraphPipelineSessionCreateMaskBitsARM : VkDataGraphPipelineSessionCreateFlagsARM {
  E_PROTECTED_BIT_ARM = VK_DATA_GRAPH_PIPELINE_SESSION_CREATE_PROTECTED_BIT_ARM,
};

enum class DataGraphPipelineSessionBindPointARM {
  E_TRANSIENT_ARM = VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_TRANSIENT_ARM,
};

enum class DataGraphPipelineSessionBindPointTypeARM {
  E_MEMORY_ARM = VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_TYPE_MEMORY_ARM,
};

enum class DataGraphPipelinePropertyARM {
  E_CREATION_LOG_ARM = VK_DATA_GRAPH_PIPELINE_PROPERTY_CREATION_LOG_ARM,
  E_IDENTIFIER_ARM = VK_DATA_GRAPH_PIPELINE_PROPERTY_IDENTIFIER_ARM,
};

enum class DataGraphPipelineDispatchMaskBitsARM : VkDataGraphPipelineDispatchFlagsARM {
};

enum class PhysicalDeviceDataGraphProcessingEngineTypeARM {
  E_DEFAULT_ARM = VK_PHYSICAL_DEVICE_DATA_GRAPH_PROCESSING_ENGINE_TYPE_DEFAULT_ARM,
};

enum class PhysicalDeviceDataGraphOperationTypeARM {
  E_SPIRV_EXTENDED_INSTRUCTION_SET_ARM = VK_PHYSICAL_DEVICE_DATA_GRAPH_OPERATION_TYPE_SPIRV_EXTENDED_INSTRUCTION_SET_ARM,
};

enum class VideoEncodeRgbModelConversionMaskBitsVALVE : VkVideoEncodeRgbModelConversionFlagsVALVE {
  E_RGB_IDENTITY_BIT_VALVE = VK_VIDEO_ENCODE_RGB_MODEL_CONVERSION_RGB_IDENTITY_BIT_VALVE,
  E_YCBCR_IDENTITY_BIT_VALVE = VK_VIDEO_ENCODE_RGB_MODEL_CONVERSION_YCBCR_IDENTITY_BIT_VALVE,
  E_YCBCR_709_BIT_VALVE = VK_VIDEO_ENCODE_RGB_MODEL_CONVERSION_YCBCR_709_BIT_VALVE,
  E_YCBCR_601_BIT_VALVE = VK_VIDEO_ENCODE_RGB_MODEL_CONVERSION_YCBCR_601_BIT_VALVE,
  E_YCBCR_2020_BIT_VALVE = VK_VIDEO_ENCODE_RGB_MODEL_CONVERSION_YCBCR_2020_BIT_VALVE,
};

enum class VideoEncodeRgbRangeCompressionMaskBitsVALVE : VkVideoEncodeRgbRangeCompressionFlagsVALVE {
  E_FULL_RANGE_BIT_VALVE = VK_VIDEO_ENCODE_RGB_RANGE_COMPRESSION_FULL_RANGE_BIT_VALVE,
  E_NARROW_RANGE_BIT_VALVE = VK_VIDEO_ENCODE_RGB_RANGE_COMPRESSION_NARROW_RANGE_BIT_VALVE,
};

enum class VideoEncodeRgbChromaOffsetMaskBitsVALVE : VkVideoEncodeRgbChromaOffsetFlagsVALVE {
  E_COSITED_EVEN_BIT_VALVE = VK_VIDEO_ENCODE_RGB_CHROMA_OFFSET_COSITED_EVEN_BIT_VALVE,
  E_MIDPOINT_BIT_VALVE = VK_VIDEO_ENCODE_RGB_CHROMA_OFFSET_MIDPOINT_BIT_VALVE,
};

} // end namespace Innsmouth

#include "graphics_masks.h"

#endif // INNSMOUTH_GRAPHICS_ENUMS_H
